...
​`,
  ...
  {
    title: "Custom Remapping",
    desc: `Enhance engine response and fuel economy through a personalized remap designed for your vehicle.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[75%] mt-15 mx-auto h-20 object-cover"
                    onError={(e) => {
