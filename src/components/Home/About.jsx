...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Got my 2012 Octavia remapped and it runs a lot better and pulls a lot harder. Recommend these guys they do an amazing job. Turned up on time, any questions I had they was happy to explain them to me and very professional.Worth every penny.",
    name: "McKenzie Cummings",
  },
